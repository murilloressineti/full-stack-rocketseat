...
Este projeto foi desenvolvido como prática de **JavaScript**, com foco na criação de formulários interativos, manipulação de elementos no DOM e organização de dados em seções visuais.
...
Confira abaixo uma prévia e acesse o projeto completo [aqui](https://agendapet.netlify.app/):
...
```cd full-stack-rocketseat/javascript/desafios/agendamento-petshop```
