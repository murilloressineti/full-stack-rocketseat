...
function UserInfo({ name, avatar }: { name: string; avatar?: string | null }) {
  return (
...
export default function TicketRow({
  ...
  return (
    <>
      {/* Desktop */}
      <div className="hidden items-center gap-2 border-b border-gray-200 px-4 py-4 md:grid md:grid-cols-[1.1fr_0.6fr_2.4fr_1fr_1.5fr_1.5fr_1.4fr_0.3fr]">
        <Text>{updatedAt}</Text>
        ...
        <UserInfo name={clientName} avatar={clientAvatar} />

        <UserInfo name={technicianName} avatar={technicianAvatar} />
