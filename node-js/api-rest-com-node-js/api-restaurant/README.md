...
A **API Restaurant** é um projeto que simula a gestão de um restaurante, permitindo o controle de **produtos, pedidos, mesas e sessões de mesas**.  
O objetivo principal é praticar o desenvolvimento de uma aplicação **Node.js com TypeScript**, integrando **banco de dados relacional com Knex**, migrations, seeds e boas práticas de organização de código.
